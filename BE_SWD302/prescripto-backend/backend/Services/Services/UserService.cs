...
namespace Services.Services
{
    public class UserService : IUserService
    {
        ...
        //{
        //    return await _unitOfWork.UserRepository.GetAllDoctorAsync();
        //}

        //public async Task<BackgroundDoctor> UpdateBackgroundDoctor(Guid id, UpdateBackgroundDoctorDto updateBackgroundDoctorDto)
        //{
        //    var backGround = await _unitOfWork.UserRepository.GetBackgroundByUserIdAsync(id);
        ...
        //    _unitOfWork.UserRepository.UpdateBackgroundDoctorAsync(backGround);
        //    await _unitOfWork.SaveChangeAsync();
        //    return backGround;
        //}
    }
